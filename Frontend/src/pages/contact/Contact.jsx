...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact CA in Bhopal | SS Superior & Associates</title>
        <meta
          name="description"
          content="Contact SS Superior & Associates, a leading Chartered Accountant in Bhopal. Call, email or visit our office for expert consultation."
        />
        <link
          rel="canonical"
          href="https://sssuperiorassociates.com/contact"
        />
      </Helmet>
