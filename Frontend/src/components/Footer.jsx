                ...
                <div className="footer-container">
                    ...
                    <div className="footer-column about-column">
                        ...
                        <p className="footer-description">
                            We are the people you can count on for help, with taxes and making sure your business
                            is doing everything it needs to do. We have been making money matters easier for
                            people since 2017.
                        </p>
                    ...
                    <div className="footer-column contact-info">
                        ...
                        <div className="contact-item">
                            ...
                            <Link to="tel:+919111656571">+91 91116 56571</Link>
                        </div>
                        <div className="contact-item">
